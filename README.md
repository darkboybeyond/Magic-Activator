...
3. Provide exact **MobileGestalt + supporting files** for your model/region/build  
   → Extract them in seconds with this shortcut:  
...
5. Record gets injected → device thinks it’s legitimately activated 🎉  
...
## Screenshot 🖼️
![Magic Activator in action](screenshot.png)
